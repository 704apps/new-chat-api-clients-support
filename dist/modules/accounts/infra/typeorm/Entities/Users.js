...
let Users = exports.Users = (_dec = (0, _typeorm.Entity)({
  name: 'users'
}), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.Column)({
  nullable: false
}), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.Column)('varchar'), _dec7 = Reflect.metadata("design:type", String), _dec8 = (0, _typeorm.Column)({
  nullable: true
}), _dec9 = Reflect.metadata("design:type", String), _dec10 = (0, _typeorm.Column)('varchar'), _dec11 = Reflect.metadata("design:type", String), _dec12 = (0, _typeorm.Column)('varchar'), _dec13 = Reflect.metadata("design:type", String), _dec14 = (0, _typeorm.Column)('boolean'), _dec15 = Reflect.metadata("design:type", Boolean), _dec16 = (0, _typeorm.OneToMany)(() => _RefreshToken.RefreshToken, refleshtoken => refleshtoken.userId), _dec17 = Reflect.metadata("design:type", Array), _dec18 = (0, _typeorm.CreateDateColumn)(), _dec19 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec20 = (0, _typeorm.UpdateDateColumn)(), _dec21 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = (_class2 = class Users {
  constructor() {
    ...
    _initializerDefineProperty(this, "refreshTokens", _descriptor8, this);
  ...
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "role", [_dec12, _dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "active", [_dec14, _dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "refreshTokens", [_dec16, _dec17], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
