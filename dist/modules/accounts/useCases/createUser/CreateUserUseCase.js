...
let CreateUserUseCase = class CreateUserUseCase {
    ...
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ name, email, password, driver_license }) {
            const passwordHash = yield (0, bcrypt_1.hash)(password, 8);
            const isuseralreadyExist = yield this.userRepository.findByEmail(email);
