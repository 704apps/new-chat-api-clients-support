...
var UploadMediaUseCase_1 = require("./UploadMediaUseCase");
var tsyringe_1 = require("tsyringe");
var UploadMediaController = /** @class */ (function () {
    function UploadMediaController() {
    }
    UploadMediaController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var file, dataBody, uploadMediaUseCase, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        dataBody = _a.sent();
                        uploadMediaUseCase = tsyringe_1.container.resolve(UploadMediaUseCase_1.UploadMediaUseCase);
                        if (!file) return [3 /*break*/, 4];
                        dataBody.filecontent = file.buffer;
                        dataBody.filename = file.originalname;
                        return [4 /*yield*/, uploadMediaUseCase.uploadMedia(dataBody)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
