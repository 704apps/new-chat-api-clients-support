...
var GetOneChatClientUseCase = /** @class */ (function () {
    function GetOneChatClientUseCase() {
        var _this = this;
        ...
        if (!app_data_source_1.myDataSource.isInitialized) {
            app_data_source_1.myDataSource.initialize().then(function () {
                _this.messageRepository = app_data_source_1.myDataSource.getRepository(Messages_1.Messages);
            }).catch(function (error) { return console.error("Error ao incializar a conexão:", error); });
        }
    }
    GetOneChatClientUseCase.prototype.getOneMessagesClient = function (chatId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.messageRepository.findBy({
                                chatId: chatId
                            })];
                    case 1:
                        project = _a.sent();
    ...
    return GetOneChatClientUseCase;
}());
exports.GetOneChatClientUseCase = GetOneChatClientUseCase;
//# sourceMappingURL=GetOneChatClientUseCase.js.map