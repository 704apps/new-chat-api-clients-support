...
var UpdateBySAUseCase_1 = require("./UpdateBySAUseCase");
...
var UpdateMessageController = /** @class */ (function () {
    ...
    UpdateMessageController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, uppdateBySAUseCase, messageUpdade, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        id = request.params.id;
                        return [4 /*yield*/, tsyringe_1.container.resolve(UpdateBySAUseCase_1.UpdateBySAUseCase)];
                    case 1:
                        uppdateBySAUseCase = _a.sent();
                        return [4 /*yield*/, uppdateBySAUseCase.upldateSA(id)];
                    case 2:
...
//# sourceMappingURL=UpdateBySAController.js.map