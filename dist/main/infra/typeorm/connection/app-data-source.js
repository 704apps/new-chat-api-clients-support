...
var _OldMessages = require("../../../../modules/messages/infra/typeorm/Entities/OldMessages");
var _RefreshToken = require("../../../../modules/refreshToken/infra/typeorm/Entities/RefreshToken");
var _Notes = require("../../../../modules/notes/infra/typeorm/Entities/Notes");
...
const fileExtension = _path.default.extname(__filename).slice(1).toLowerCase();
let adressFile = '';
if (fileExtension === 'js') {
...
const myDataSource = exports.myDataSource = new _typeorm.DataSource({
  ...
  entities: [_Messages.Messages, _OldMessages.OldMessages, _Contacts.Contacts, _Chats.Chats, _Users.Users, _RefreshToken.RefreshToken, _Notes.Notes],
