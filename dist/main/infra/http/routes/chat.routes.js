...
chatRouter.post('/create_chat/', ensureAuthenticated_1.ensureAuthenticated, getCreateChatController.handle);
// chatRouter.patch('/update_statusAttention/:id',(req,res)=>chatController.getUpdateStatusAttention(req,res))
chatRouter.patch('/update_statusFinished/:id', ensureAuthenticated_1.ensureAuthenticated, updateStatusFinishedController.handle);
chatRouter.patch('/update_statusOpen/:id', ensureAuthenticated_1.ensureAuthenticated, updateStatusOpenController.handle);
